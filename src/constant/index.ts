export const PROJECTS = [
  ...
  },
  {
    ...
    title: "X-Wings Design System",
    description:
      "Architected and maintained a centralized UI library to unify the design language across 4+ internal and external products. Built with Storybook and React, this system accelerated feature delivery speed by ~30% and ensured consistent accessibility (a11y) standards across the organization.",
    skills: [
      "React",
      "Storybook",
      "NPM Package",
